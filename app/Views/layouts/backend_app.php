...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <link rel="shortcut icon" href="<?= site_url();?>assets/backend/img/favicon.png">
        <link rel="apple-touch-icon" href="<?= site_url();?>assets/backend/img/icon57.png" sizes="57x57">
        <link rel="apple-touch-icon" href="<?= site_url();?>assets/backend/img/icon72.png" sizes="72x72">
        <link rel="apple-touch-icon" href="<?= site_url();?>assets/backend/img/icon76.png" sizes="76x76">
        <link rel="apple-touch-icon" href="<?= site_url();?>assets/backend/img/icon114.png" sizes="114x114">
        <link rel="apple-touch-icon" href="<?= site_url();?>assets/backend/img/icon120.png" sizes="120x120">
        <link rel="apple-touch-icon" href="<?= site_url();?>assets/backend/img/icon144.png" sizes="144x144">
        <link rel="apple-touch-icon" href="<?= site_url();?>assets/backend/img/icon152.png" sizes="152x152">
        <link rel="apple-touch-icon" href="<?= site_url();?>assets/backend/img/icon180.png" sizes="180x180">
        <!-- END Icons -->
                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <a href="index.html" class="sidebar-brand">
                                <span class="sidebar-nav-mini-hide"><strong>DSS</strong> AMD</span>
                            </a>
                            <!-- END Brand -->
                            ...
                            <div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
                                <div class="sidebar-user-avatar">
                                    <a href="page_ready_user_profile.html">
                                        <img src="<?= site_url();?>assets/backend/img/placeholders/avatars/avatar2.jpg" alt="avatar">
                                    </a>
                                </div>
                            ...
                            <!--ul class="sidebar-section sidebar-themes clearfix sidebar-nav-mini-hide">
                                ...
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-night themed-border-night" data-theme="<?= site_url();?>assets/backend/css/themes/night.css" data-toggle="tooltip" title="Night"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-amethyst themed-border-amethyst" data-theme="<?= site_url();?>assets/backend/css/themes/amethyst.css" data-toggle="tooltip" title="Amethyst"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-modern themed-border-modern" data-theme="<?= site_url();?>assets/backend/css/themes/modern.css" data-toggle="tooltip" title="Modern"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-autumn themed-border-autumn" data-theme="<?= site_url();?>assets/backend/css/themes/autumn.css" data-toggle="tooltip" title="Autumn"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-flatie themed-border-flatie" data-theme="<?= site_url();?>assets/backend/css/themes/flatie.css" data-toggle="tooltip" title="Flatie"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-spring themed-border-spring" data-theme="<?= site_url();?>assets/backend/css/themes/spring.css" data-toggle="tooltip" title="Spring"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-fancy themed-border-fancy" data-theme="<?= site_url();?>assets/backend/css/themes/fancy.css" data-toggle="tooltip" title="Fancy"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-fire themed-border-fire" data-theme="<?= site_url();?>assets/backend/css/themes/fire.css" data-toggle="tooltip" title="Fire"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-coral themed-border-coral" data-theme="<?= site_url();?>assets/backend/css/themes/coral.css" data-toggle="tooltip" title="Coral"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-lake themed-border-lake" data-theme="<?= site_url();?>assets/backend/css/themes/lake.css" data-toggle="tooltip" title="Lake"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-forest themed-border-forest" data-theme="<?= site_url();?>assets/backend/css/themes/forest.css" data-toggle="tooltip" title="Forest"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-waterlily themed-border-waterlily" data-theme="<?= site_url();?>assets/backend/css/themes/waterlily.css" data-toggle="tooltip" title="Waterlily"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-emerald themed-border-emerald" data-theme="<?= site_url();?>assets/backend/css/themes/emerald.css" data-toggle="tooltip" title="Emerald"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-blackberry themed-border-blackberry" data-theme="<?= site_url();?>assets/backend/css/themes/blackberry.css" data-toggle="tooltip" title="Blackberry"></a>
                                </li>
                            </ul-->
                            <!-- END Theme Colors -->
                ...
                <div id="main-container">
                    ...
                    <header class="navbar navbar-default">
                        ...
                        <ul class="nav navbar-nav-custom pull-right">
                            ...
                            <li class="dropdown">
                                <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?= site_url();?>assets/backend/img/placeholders/avatars/avatar2.jpg" alt="avatar"> <i class="fa fa-angle-down"></i>
                                </a>
   ...
   <script src="<?= site_url();?>assets/backend/js/vendor/jquery.min.js"></script>
        ...
        <script src="<?= site_url();?>assets/backend/js/helpers/gmaps.min.js"></script>

        <!-- Load and execute javascript code used only in this page -->
        <script src="<?= site_url();?>assets/backend/js/pages/index.js"></script>
