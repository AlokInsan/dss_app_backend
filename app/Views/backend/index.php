<?= $this->extend("layouts/backend_app") ?>
...
<div id="page-content">
                        ...
                        <div class="content-header content-header-media">
                            ...
                            <img src="<?= site_url();?>assets/backend/img/placeholders/headers/dashboard_header.jpg" alt="header image" class="animation-pulseSlow">
                        </div>
                                            ...
                                            <ul class="timeline-list">
                                                    ...
                                                    <div class="timeline-content">
                                                        ...
                                                        <div class="row push">
                                                            <div class="col-sm-6 col-md-4">
                                                                <a href="<?= site_url();?>assets/backend/img/placeholders/photos/photo1.jpg" data-toggle="lightbox-image">
                                                                    <img src="<?= site_url();?>assets/backend/img/placeholders/photos/photo1.jpg" alt="image">
                                                                </a>
                                                            </div>
                                                            <div class="col-sm-6 col-md-4">
                                                                <a href="<?= site_url();?>assets/backend/img/placeholders/photos/photo22.jpg" data-toggle="lightbox-image">
                                                                    <img src="<?= site_url();?>assets/backend/img/placeholders/photos/photo22.jpg" alt="image">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="active">
                                                    ...
                                                    <div class="timeline-content">
                                                        ...
                                                        <div class="row push">
                                                            <div class="col-sm-6 col-md-4">
                                                                <a href="<?= site_url();?>assets/backend/img/placeholders/photos/photo23.jpg" data-toggle="lightbox-image">
                                                                    <img src="<?= site_url();?>assets/backend/img/placeholders/photos/photo23.jpg" alt="image">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="widget">
                                    <div class="widget-advanced widget-advanced-alt">
                                        ...
                                        <div class="widget-header text-left">
                                            ...
                                            <img src="<?= site_url();?>assets/backend/img/placeholders/headers/widget5_header.jpg" alt="background" class="widget-background animation-pulseSlow">
                                            ...
                                            <div class="gallery gallery-widget" data-toggle="lightbox-gallery">
                                                <div class="row">
                                                    <div class="col-xs-6 col-sm-3">
                                                        <a href="<?= site_url();?>assets/backend/img/placeholders/photos/photo15.jpg" class="gallery-link" title="Image Info">
                                                            <img src="<?= site_url();?>assets/backend/img/placeholders/photos/photo15.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <a href="<?= site_url();?>assets/backend/img/placeholders/photos/photo5.jpg" class="gallery-link" title="Image Info">
                                                            <img src="<?= site_url();?>assets/backend/img/placeholders/photos/photo5.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <a href="<?= site_url();?>assets/backend/img/placeholders/photos/photo6.jpg" class="gallery-link" title="Image Info">
                                                            <img src="<?= site_url();?>assets/backend/img/placeholders/photos/photo6.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <a href="<?= site_url();?>assets/backend/img/placeholders/photos/photo13.jpg" class="gallery-link" title="Image Info">
                                                            <img src="<?= site_url();?>assets/backend/img/placeholders/photos/photo13.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
